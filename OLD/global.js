...
var initEvents = function(){
	events.push(["11/25", "2:00","Autonomous Robotic Systems lecture", ["robojackets","autonomous"], "Howey H1", "8", "#", "Robojackets"]);
events.push(["11/25", "4:30","Pillowfight in Tech Green", ["pillowfight","pillowpet"], "Tech Green", "4", "#", "Vaun"]);
events.push(["11/25", "5:00","Richard Meet and Greet", ["richard","woodruff"], "Woodruff Residence Hall", "7", "#", "Woodruff Residence Hall"]);
events.push(["11/25", "5:00","Churchill Grounds Organ Trio", ["jazz","music"], "Churchill Grounds Jazz Club", "7", "#", "Churchill Grounds"]);
events.push(["11/25", "6:00","Richard Meet and Greet", ["richard","woodruff"], "Woodruff Residence Hall", "7", "#", "Woodruff Residence Hall"]);
events.push(["11/25", "6:00","Freshmen touch Ramblin Wreck", ["ramblin","helluva"], "Place Wreck is Kept", "7", "#", "Bad Freshmen Club"]);
events.push(["11/25", "6:00","2015 Freshmen 5K", ["run","fast"], "Pi Mile", "7", "#", "Running Club"]);
events.push(["11/25", "7:30","Come touch a ferrari", ["gtms","car"], "Student Competition Center", "7", "#", "gtms"]);
events.push(["11/25", "8:00","Bungee Jumping", ["bungee","xtreme"], "Tech Tower", "7", "#", "CRC"]);
events.push(["11/25", "4:00","S'mores Night at Woodys!", ["s'mores","woodruff","thanksgiving"], "Woodruff Residence Hall", "7", "#", "Woodruff Residence Hall"]);
	...
	for (i=0; i<events.length; i++) {
		...
		s += '<div id = eventWrapper>'
			s += '<div id = event>'
				...
				s += '<div id = eventInfo> submitted '+e[5]+' hours ago by <a href = "">'+e[7]+'</a></div>'
				s += '<a href = "#">	'
					s += '<div id = showMore>'
...
var expand = function() {
	...
	$( "#wrapper #eventWrapper #event a #showMore" ).click(function() {
		...
		eventdiv.append(s);
		eventdiv.append('<div id = eventInfo> submitted '+events[2][5]+' hours ago by <a href = "'+events[2][6]+'">'+events[2][7]+'</a></div>');
